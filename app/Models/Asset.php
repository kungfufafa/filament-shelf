...
class Asset extends Model
{
    ...
    /**
     * Whether the given user holds the general_affair role. Uses the simple
    ...
    {
        return $user !== null && $user->hasRole('general_affair');
    }
    ...
    public function recipientBusinessEntity(): BelongsTo
    {
    ...
    /**
     * Pengajuan aset yang menjadi sumber aset ini (nullable). Link "aset
     * dibuat dari pengajuan X".
     */
