...
class AssetRequest extends Model
{
    ...
    /**
     * Default attribute values for new requests.
     *
    ...
    {
        static::creating(function (AssetRequest $assetRequest): void {
        ...
        static::created(function (AssetRequest $assetRequest): void {
    ...
    public function rebuildApprovalChain(bool $notify = true): void
    {
        ...
        if ($approvers->isEmpty()) {
            ...
            if ($notify && $this->user) {
                $assetRequest = $this;
                DB::afterCommit(function () use ($assetRequest): void {
    ...
    public function fulfillPengadaan(array $assetAttributes, User $actor): Asset
    {
        ...
        return DB::transaction(function () use ($assetAttributes, $actor): Asset {
            $this->refresh();
            $this->ensureFulfillable(AssetRequestType::Pengadaan);
    ...
    public function fulfillPerbaikan(User $actor): Asset
    {
        ...
        return DB::transaction(function () use ($assets, $actor): Asset {
    ...
    public function fulfillPenarikan(User $gaUser, User $actor, ?string $letterNumber = null): AssetTransfer
    {
        ...
        return DB::transaction(function () use ($assets, $gaUser, $actor, $letterNumber): AssetTransfer {
    ...
    public function approveCurrentLevel(?string $notes = null, ?User $actor = null): void
    {
        ...
        $notifications = DB::transaction(function () use ($actor, $notes): array {
